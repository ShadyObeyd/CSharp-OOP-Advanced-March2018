...
[Inferno("Pesho", 3, "Used for C# OOP Advanced Course - Enumerations and Attributes.", "Pesho", "Svetlio")]
class StartUp
{
    ...
    static void Main()
    {
        ...
        InfernoAttribute attr = (InfernoAttribute)typeof(StartUp).GetCustomAttributes(false).First();
